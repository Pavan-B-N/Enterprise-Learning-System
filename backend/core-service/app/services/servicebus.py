"""Azure Service Bus producer + consumer for core-service.

Same envelope and behavior as assessment-service/app/servicebus.py.
"""
...
class ServiceBusPublisher:
    def __init__(self, connection_string: str, source: str = "core-service") -> None:
